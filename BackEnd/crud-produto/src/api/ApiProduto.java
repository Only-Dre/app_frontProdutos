...
public class ApiProduto {
    ...
    public static void main(String[] args) {
        ...
        // Categoria categoriaParaAtualizar = gson.fromJson(request.body(),
        // Categoria.class);
        ...
        get("/categorias", (request, response) -> gson.toJson(categoriaDAO.buscarTodos())); // Função anônima de return
                                                                                            // '->'
        ...
        delete("/categorias/:id", (request, response) -> {
                try {
                    ...
                    categoriaDAO.deletar(id); // Usa Long ID
                    ...
                    response.status(400);
                    return "{\"mensagem\": \"Formato de ID inválido.\"}";
                } catch(Exception e) { // Catch de causa
